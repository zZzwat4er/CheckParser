...
class RemoteCheckRepository {
  ...
  Future<bool?> sendCheck(Check check) async {
    ...
    late final ServerResponce res;
    if (responce.data != null) {
      res = ServerResponce.fromJson(json.decode(responce.data!));
    }
  ...
  Future<List<ServerCheck>?> getChecks(int beginId, int offset) async {
    ...
    if (responce.data != null) {
      ...
      return list.map((e) => ServerCheck.fromJson(e as Map<String, dynamic>)).toList();
    }
    return [];
  }
}
